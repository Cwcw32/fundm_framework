...
class BMRC(nn.Module):
    ...
    def forward(self,
        ...
        :return:
        """
        result= self._bert(query_tensor, attention_mask=query_mask, token_type_ids=query_seg)[0]
...
class BMRC_2(nn.Module):
    ...
    def forward(self,
        ...
        :return:
        """
        result= self._bert(query_tensor, attention_mask=query_mask, token_type_ids=query_seg)

...
def compare_to_save(last_value, now_value, opt, bert_model, train_log, dev_log, compare_target, threshold, add_new_note=None, last_model_name=None, add_enter=True,rank=-1):
    """
    :param last_value:
    :param now_value:
    :param opt:
